...
# MiniMax API配置
# 默认配置（开发环境使用）
_DEFAULT_MINIMAX_API_KEY = "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9..szVUN2AH7lJ9fQ3EYfzcLcamSCFAOye3Y6yO3Wj_tlNhnhBIYxEEMvZsVgH9mgOe6uhRczOqibmEMbVMUD_1DqtykrbD5klaB4_nhRnDl8fbaAf7m8B1OTRTUIiqgXRVglITenx3K_ugZ6teqiqypByJoLleHbZCSPWvy1-NaDiynb7qAsGzN1V6N4BOTNza1hL5PYdlrXLe2yjQv3YW8nOjQDIGCO1ZqnVBF0UghVaO4V-GZu1Z_0JnkLa7x_2ZXKXAe-LWhk9npwGFzQfLL3aH4oUzlsoEDGnuz3RZdZsFCe95MUiG8dCWfsxhVqlQ5GoFM3LQBAXuLZyqDpmSgg"
_DEFAULT_MINIMAX_GROUP_ID = "1747179187841536150"

# 优先使用环境变量，如果不存在则使用默认值
MINIMAX_API_KEY = os.getenv('MINIMAX_API_KEY', _DEFAULT_MINIMAX_API_KEY)
MINIMAX_GROUP_ID = os.getenv('MINIMAX_GROUP_ID', _DEFAULT_MINIMAX_GROUP_ID)
MINIMAX_API_BASE_URL = os.getenv('MINIMAX_API_BASE_URL', 'https://api.minimaxi.com')
